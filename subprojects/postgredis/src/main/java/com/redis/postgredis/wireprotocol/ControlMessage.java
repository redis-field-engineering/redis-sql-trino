...
import com.redis.postgredis.metadata.SendResultSetState;
import com.redis.postgredis.statements.IntermediateStatement;
import com.redis.postgredis.wireoutput.CommandCompleteResponse;
import com.redis.postgredis.wireoutput.DataRowResponse;
import com.redis.postgredis.wireoutput.ErrorResponse;
import com.redis.postgredis.wireoutput.PortalSuspendedResponse;
import com.redis.postgredis.wireoutput.ReadyResponse;
import com.redis.postgredis.wireoutput.ErrorResponse.State;
...
public abstract class ControlMessage extends WireMessage {
   ...
   */
  public boolean sendRedisResult(IntermediateStatement statement, QueryMode mode, long maxRows)
      throws Exception {
