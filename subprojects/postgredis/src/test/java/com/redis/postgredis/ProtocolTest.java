...
import com.redis.postgredis.ConnectionHandler;
import com.redis.postgredis.ProxyServer;
import com.redis.postgredis.ConnectionHandler.QueryMode;
import com.redis.postgredis.metadata.ConnectionMetadata;
import com.redis.postgredis.metadata.DescribePortalMetadata;
import com.redis.postgredis.metadata.DescribeStatementMetadata;
...
import com.redis.postgredis.statements.MatcherStatement;
import com.redis.postgredis.wireprotocol.BindMessage;
import com.redis.postgredis.wireprotocol.BootstrapMessage;
import com.redis.postgredis.wireprotocol.CancelMessage;
import com.redis.postgredis.wireprotocol.CloseMessage;
import com.redis.postgredis.wireprotocol.ControlMessage;
import com.redis.postgredis.wireprotocol.CopyDataMessage;
import com.redis.postgredis.wireprotocol.CopyDoneMessage;
import com.redis.postgredis.wireprotocol.CopyFailMessage;
import com.redis.postgredis.wireprotocol.DescribeMessage;
import com.redis.postgredis.wireprotocol.ExecuteMessage;
import com.redis.postgredis.wireprotocol.FlushMessage;
import com.redis.postgredis.wireprotocol.FunctionCallMessage;
import com.redis.postgredis.wireprotocol.ParseMessage;
import com.redis.postgredis.wireprotocol.QueryMessage;
import com.redis.postgredis.wireprotocol.SSLMessage;
import com.redis.postgredis.wireprotocol.StartupMessage;
import com.redis.postgredis.wireprotocol.SyncMessage;
import com.redis.postgredis.wireprotocol.TerminateMessage;
import com.redis.postgredis.wireprotocol.WireMessage;
import com.redis.postgredis.wireprotocol.ControlMessage.PreparedType;
...
public class ProtocolTest {
  ...
  public void testExecuteMessage() throws Exception {
    ...
    Mockito.doReturn(false)
        .when(messageSpy)
        .sendRedisResult(any(IntermediatePortalStatement.class), any(QueryMode.class), anyLong());

    messageSpy.send();

    Mockito.verify(intermediatePortalStatement, Mockito.times(1)).execute();
    Mockito.verify(messageSpy, Mockito.times(1))
        .sendRedisResult(intermediatePortalStatement, QueryMode.EXTENDED, totalRows);
