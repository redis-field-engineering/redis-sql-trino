...
/**
 * Relational expression representing a scan of an RediSearch type.
 *
...
public class RediSearchTableScan extends TableScan implements RediSearchRel {
  private final RediSearchTable rediSearchTable;
   ...
   * @param table Table
   * @param rediSearchTable Elasticsearch table
   * @param projectRowType Fields and types to project; null to project raw row
   */
  RediSearchTableScan(RelOptCluster cluster, RelTraitSet traitSet,
       RelOptTable table, RediSearchTable rediSearchTable,
       RelDataType projectRowType) {
    super(cluster, traitSet, ImmutableList.of(), table);
    this.rediSearchTable = Objects.requireNonNull(rediSearchTable, "rediSearchTable");
